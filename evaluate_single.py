...
def calculate_metrics(generated_route: list, ground_truth_route: list) -> tuple[float, float]:
    """
    Calculates Precision and Recall based on the formulas in the PKDD draft.
    """
...
if __name__ == "__main__":
    ...
    # Load your OSM edges dataframe (make sure not to reset the index!)
